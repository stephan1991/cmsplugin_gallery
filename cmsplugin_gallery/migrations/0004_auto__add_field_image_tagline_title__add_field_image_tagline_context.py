...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.tagline_title'
        db.add_column(u'cmsplugin_gallery_image', 'tagline_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Image.tagline_context'
        db.add_column(u'cmsplugin_gallery_image', 'tagline_context',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.tagline_title'
        db.delete_column(u'cmsplugin_gallery_image', 'tagline_title')

        # Deleting field 'Image.tagline_context'
        db.delete_column(u'cmsplugin_gallery_image', 'tagline_context')
    ...
    models = {
        ...
        u'cmsplugin_gallery.image': {
            ...
            'tagline_context': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'tagline_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
